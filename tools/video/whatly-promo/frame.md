...
description: >
  ...
  accent, the three-step gray text ladder, DejaVu Sans (display/numerals/chrome) + DejaVu Sans (body),
...
colors:
  ...
  accent-medium: "rgba(45, 212, 191, 0.15)"
  border: "rgba(45, 212, 191, 0.2)"
  card-bg: "rgba(45, 212, 191, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (DejaVu Sans body + DejaVu Sans chrome) —
  body:    { fontFamily: "DejaVu Sans", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "DejaVu Sans", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "DejaVu Sans", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "DejaVu Sans", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (DejaVu Sans, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "DejaVu Sans", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "DejaVu Sans", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "DejaVu Sans", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "DejaVu Sans", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "DejaVu Sans", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "DejaVu Sans", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "DejaVu Sans", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **DejaVu Sans** (display) / **sans-serif** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **DejaVu Sans** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **DejaVu Sans** (body, muted gray, line 1.6). Headlines are near-black;
...
- **DejaVu Sans** (display/numerals/chrome) + **DejaVu Sans** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (DejaVu Sans body 0.85cqw muted; DejaVu Sans eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (DejaVu Sans `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body DejaVu Sans 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line DejaVu Sans `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + DejaVu Sans label + muted desc + optional
...
blockquote, cite. **Focal** a DejaVu Sans `blockquote` near-black under a 15%-opacity cobalt
...
DejaVu Sans body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a DejaVu Sans `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body DejaVu Sans 400 muted, line 1.6.
...
- **Type** — DejaVu Sans headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; DejaVu Sans body muted line 1.6; ≥1.4cqw floor.
...
- **DejaVu Sans + DejaVu Sans via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
